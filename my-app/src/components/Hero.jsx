    ...
    <section id="home" className="hero">
      <div className="hero-content">
        ...
        <div className="hero-buttons">
          ...
          <a href="https://drive.google.com/file/d/1LeNQqy6RgkWTwqmHpJMBV4mm6O0UoUJn/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn resume">
        ...
        <div className="social-links">
          ...
          <a href="https://www.youtube.com/@heyitsrr?si=QIWjmKRZZFrF6sU7" target="_blank" rel="noopener noreferrer" title="YouTube">
